...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    // pathParts[0] = 'dashboard', pathParts[1] = tab, pathParts[2] = id (if exists)
    const pathPart = pathParts[1] || 'dashboard'
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Main Content */}
      <div className={`pt-20 p-6 pb-12 transition-all duration-300 min-h-screen ${sidebarExpanded ? 'ml-64' : 'ml-16'
        }`}>
        {loading ? (
